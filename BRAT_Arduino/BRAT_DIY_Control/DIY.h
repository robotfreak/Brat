...
boolean newData;  //Data flag
boolean newValues = false;
byte Status;  //Modem status
byte Chksum;  //Packet Chksum
boolean isConnected = false; //Connected Flag. Is true if recieving ACK's
boolean isReady = false;  //Ready Flag. Is true if have recieved XBEE_READY from robot
boolean imReady = false;  //imReadt Flag. Is true when Ready to serve data
