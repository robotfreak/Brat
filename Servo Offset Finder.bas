...
;System variables
; Note; these defines are only used in the table below, could simply code into table.
righthip		con p10 
rightknee		con p8 
rightankle		con p7 
lefthip			con p6 
...
; Will read in the zero points that were last saved for the different servos
